...
# Script สำหรับ Deploy Backend ไปยัง Heroku โดยใช้ Database ที่มีอยู่แล้ว
# ใช้: ./deploy-with-existing-db.sh

set -e  # หยุดการทำงานถ้าเกิด error

echo "🚀 เริ่มการ Deploy Backend ไปยัง Heroku ด้วย Database ที่มีอยู่แล้ว..."
...
echo "🚀 Deploy Code..."
git add .
git commit -m "Deploy to Heroku with existing database: $APP_NAME" || true
